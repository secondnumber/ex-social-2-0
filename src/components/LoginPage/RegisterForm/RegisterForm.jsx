    ...
    return (
        <div className={classes.wrapper}>
            ...
            <form action="">
                ...
                <input type="password" className={classes.passwordRepeat} placeholder="Repeat Password"/>
                <label><input type="checkbox" className={classes.send} />Send me news and updates via email</label>
                <button className={classes.login}>Register Now!</button>
                <p>You'll receive a confirmation email in your inbox with a link to activate your account. 
